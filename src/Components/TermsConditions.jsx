    ...
    return (
        <>
            ...
            <div className="px-10 py-8 bg-slate-100 dark:bg-slate-800 shadow-lg shadow-gray-600">
                <h2 className="text-4xl font-bold text-white">Terms & Condition</h2>

                <ul className="px-10 py-8">
                    <li className="text-white">
                        <h1 className="font-bold text-2xl">1. Acceptance of Terms :<br/></h1>
                    ...
                    <li className="text-white">
                        <h1 className="font-bold text-2xl">2. Use of Website :<br/></h1>
