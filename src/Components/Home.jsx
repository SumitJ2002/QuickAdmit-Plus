      ...
      <div className="px-10 py-8 bg-slate-100 dark:bg-slate-800 shadow-lg shadow-gray-600">
        <div className="head-banner flex flex-col md:flex-row p-5 w-full h-auto bg-violet-800 rounded-2xl">
          <div className="w-full md:w-[50%] flex flex-col items-start justify-center">
            <h1 className="px-3 text-3xl font-bold text-white">
              Empowering Healthcare Solutions
            </h1>
            <p className="px-3 py-5 text-lg text-justify font-bold text-white">
              At QuickAdmit Plus, we are revolutionizing healthcare with
              innovative solutions. Explore our services and join us in shaping
              the future of healthcare today
            </p>

            <button className="mx-3 px-10 py-3 bg-white font-bold text-md text-violet-600 rounded-md">
              Join Us
            </button>
          </div>
        ...
        <div
          className="head-footer px-5 py-10 flex flex-col items-center justify-center w-full"
          id="about"
        >
          <h3 className="text-lg font-bold text-green-500">
            EXPLORING THE HORIZON OF HEALTHCARE FUTURE
          </h3>
          <h2 className="py-5 text-4xl font-bold text-slate-800 dark:text-white">
          ...
          <div className="head-footer-container p-5 flex flex-col md:flex-row gap-4 items-center justify-center w-full">
            <div className="card p-5 h-auto bg-blue-400 w-full md:w-[30%] rounded-xl">
              ...
              <p className="text-xl py-5 font-serif">
                to organise all your medical records
              </p>
              <button className="px-10 py-4 bg-white font-bold text-md text-violet-600 rounded-md">
                UPLOAD A RECORD
              </button>
        ...
        <div className="head-banner flex flex-col md:flex-row p-5 w-full h-auto bg-slate-800 dark:bg-slate-100 rounded-2xl">
          <div className="w-full md:w-[50%] flex flex-col items-start justify-center">
            <h3 className="px-3 text-2xl font-bold text-green-500 dark:text-violet-600">
              JOIN THE HEALTHCARE REVOLUTION IN INDIA
            </h3>
            <h2 className="px-3 py-3 text-4xl font-bold text-white dark:text-black">
              Forging Ahead in India Healthcare Transformation
            </h2>
            <p className="px-3 py-5 text-xl text-justify font-bold text-slate-300 dark:text-slate-600">
              At QuickAdmit Plus, we are revolutionizing healthcare with
              innovative solutions. Explore our services and join us in shaping
              the future of healthcare today
            </p>

            <button className="mx-3 px-10 py-3 bg-white dark:bg-slate-800 font-bold text-md text-violet-600 dark:text-white rounded-md">
              CREATE QUICKADMIT PLUS ACCOUNT
            </button>
          </div>
          <div className="w-full md:w-[50%] flex flex-col items-center">
        ...
        <div className="head-footer px-5 py-10 flex flex-col items-center justify-center w-full">
          ...
          <p className="py-2 text-xl text-slate-100">
            Store, search and organise all medical records as per your
            convenience
          </p>
          <div className="head-footer-container p-5 flex flex-col md:flex-row gap-4 items-center justify-center w-full">
            <div className="card p-7 h-auto w-full md:w-[50%] flex flex-col gap-4 rounded-xl">
              <div className="flex flex-row gap-4">
                ...
                <div className="flex flex-col">
                  <h2 className="text-2xl font-bold text-violet-600 dark:text-white">
                    Store
                  </h2>
                  <p className="py-2 text-xl text-justify text-black dark:text-white">
                    QuickAdmit Plus integrated approach allows you to fetch
                    medical records from hospitals, labs, doctors and even your
                    email using facial recognition technique !
                  </p>
                </div>
              </div>
              <div className="flex flex-row gap-4">
              ...
              <div className="flex flex-row gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="py-2 text-xl text-justify text-black dark:text-white">
                    Auto organise your medical records into Labs, prescription,
                    Scans & more
                  </p>
                </div>
              </div>
